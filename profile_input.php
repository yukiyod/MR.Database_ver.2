...
<body>
    ...
    <form method="post" action="profile_input_act.php">
        <div class="profile_input_form">
            <fieldset>
                <legend>Setup your Profile</legend>
                <div class="residence">Residence&ensp;&ensp;&ensp;
                    <label>&ensp;City Name &ensp; <input type="text" name="city"></label>&ensp;&ensp;
                ...
                <div class="inst_label">
                    <label>Institution &ensp;&ensp;&ensp; <input type="text" name="inst"></label><br></div>
                <div class="dep_label">
                    <label>Department &ensp;&ensp;<input type="text" name="dept"></label><br></div>
                <div class="comment_box">
                    Comment&ensp;<br> <textArea name="comment" rows="3" cols="76"></textArea><br>
                </div>
                <div class="tag_label">
                ...
                <div class="facebook">
                    <label><i class="fab fa-facebook-square my_fb"></i> Facebook &ensp;<input type="text" name="facebook" placeholder="https://www.facebook.com/●●●●●" size="50"></label><br></div>
                <div class="twitter">
                    <label><i class="fab fa-twitter my_tw"></i> Twitter &ensp;&ensp;&ensp;<input type="text" name="twitter" placeholder="https://www.twitter.com/●●●●●" size="50"></label><br></div>
